		...
		if (e.getSender() instanceof ProxiedPlayer) {
			...
			if (pl.hasPermission("chat.owner")) {
				...
				msg = (ChatColor.GRAY + "[" + ChatColor.GREEN + "Mini-VIP"
						+ ChatColor.GRAY + "]" + ChatColor.DARK_GREEN + player
						+ ChatColor.DARK_AQUA + "> " + ChatColor.RESET
						+ ChatColor.WHITE + m);
				...
				String m1 = CTBBCCrossChat.colorize(m);
				msg = (ChatColor.GRAY + "[" + ChatColor.YELLOW + ChatColor.BOLD
						+ "Premium" + ChatColor.RESET + ChatColor.GRAY + "]"
						+ ChatColor.GREEN + player + ChatColor.DARK_AQUA + "> "
